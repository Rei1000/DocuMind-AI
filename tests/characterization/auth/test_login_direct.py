"""
Direct Login Test
Testet Login direkt mit Standard-Datenbank (ohne ab_runner)
"""
...
class TestLoginDirect:
    """Testet Login direkt mit Standard-Datenbank"""
    
    def test_login_direct(self):
        """Testet Login direkt mit Standard-Datenbank"""
        print("Teste Login direkt mit Standard-Datenbank...")
        ...
        # Test erfolgreich
        assert True, "Login direct test completed"
