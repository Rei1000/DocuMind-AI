"""
STANDARD_NORM-Prompt für Standards und Normen (ISO, IEC, DIN, EN)

Spezialisierter Prompt für die Analyse von standards und normen (iso, iec, din, en)
gemäß ISO 13485 und MDR.

VERSION: v2.1.0 (2025-07-02)
ZIEL: Detaillierte Extraktion von Normen und Standards
"""

VERSION_STANDARD_NORM = "v2.1.0 (2025-07-02)"

PROMPT_STANDARD_NORM = """
