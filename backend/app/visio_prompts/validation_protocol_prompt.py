"""
VALIDATION_PROTOCOL-Prompt für Validierungsprotokoll (IQ/OQ/PQ)

Spezialisierter Prompt für die Analyse von validierungsprotokoll (iq/oq/pq)
gemäß ISO 13485 und MDR.

VERSION: v2.1.0 (2025-07-02)
ZIEL: Detaillierte Extraktion von Validierungsprotokollen
"""

VERSION_VALIDATION_PROTOCOL = "v2.1.0 (2025-07-02)"

PROMPT_VALIDATION_PROTOCOL = """
